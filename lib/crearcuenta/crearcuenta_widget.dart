...
class _CrearcuentaWidgetState extends State<CrearcuentaWidget> {
  ...
  final url = Uri.parse("http://10.40.30.37:3000/api/v1/usuarios/crear");
  ...
  void initState() {
    ...
    _model.apellidopController ??= TextEditingController();
    _model.apellidopFocusNode ??= FocusNode();
    _model.apellidomController ??= TextEditingController();
    _model.apellidomFocusNode ??= FocusNode();
    ...
    final user = {"dni": _model.dniController.text,
    "nombres": _model.nombreController.text,
    "apellidop": _model.apellidopController.text,
    "apellidom": _model.apellidomController.text,
    "correo": _model.correoController.text,
    "telefono": _model.telefonoController.text,
    "direccion": _model.direccionController.text,
    "contraseña": _model.contrasenaController.text};
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            TextButton(
              onPressed: () {
                context.pushNamed('login'); // Cierra la alerta
              },
              child: Text('Cerrar'),
            ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: 370.0,
                                      child: TextFormField(
                                        controller: _model.apellidopController,
                                        focusNode: _model.apellidopFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.name],
                                        obscureText: false,
                                        decoration: InputDecoration(
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      width: 370.0,
                                      child: TextFormField(
                                        controller: _model.apellidomController,
                                        focusNode: _model.apellidomFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.name],
                                        obscureText: false,
                                        decoration: InputDecoration(
