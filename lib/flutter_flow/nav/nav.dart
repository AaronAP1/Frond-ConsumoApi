...
import 'package:login_simple_crud/EditarProducto/editar_producto_widget.dart';
import 'package:login_simple_crud/agregarproducto/agregarproducto_widget.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => BaseWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
